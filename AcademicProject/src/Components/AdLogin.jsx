...
function AdLogin() {
  ...
  return (
    <div className='flex justify-center items-center h-screen  bg-[url("https://media.istockphoto.com/id/1493013286/photo/businessman-logging-on-to-a-password-protected-website.jpg?s=612x612&w=0&k=20&c=T8d5OU59JrtFQQmdx0ANwlLdV7Of0B9QyN-ZfY79CUY=")] bg-no-repeat bg-cover'>
